        ...
        <>
          <div className="!mt-8 sm:!mt-14 pb-16 ">
            <div className="w-full flex flex-col items-center justify-center space-y-4 sm:space-y-6">
              ...
              <h1
                className={`text-primaryOne font-semibold text-[32px] sm:text-[40px]  `}
              >
                {` ${payment.Amount}`}
              </h1>
            </div>

            <div className="mt-[48px] sm:mt-[80px] w-full flex items-center justify-end !mb-4 px-4 sm:px-8 ">
              <div
                onClick={() =>
                  router.push(`/dashboard/payments/edit/${payment.Id}`)
                }
