...
const BoxLink: React.FC<Props> = ({ title, text, icon, link }) => {
  return (
    <div className="flex w-full flex-col space-y-2">
      ...
      <div className="flex w-full items-center justify-between cursor-pointer rounded-[10px] bg-transparent border border-secondaryOne dark:bg-darkOne dark:border-0 p-[18px] md:p-[20px]">
