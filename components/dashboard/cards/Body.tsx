    ...
    <div className='px-4 sm:px-[43px] lg:px-6 font-Poppins !mt-8 sm:!mt-8 pb-10'>
        {
            ...
            <div className='flex flex-col w-full space-y-5'>
                ...
                <div className='!mt-[66px] w-full flex flex-col space-y-14 justify-center items-center '> 
                    <h3 className=' text-sm sm:text-[17px] text-center max-w-[341px] leading-7 ' >We provide you with a virtual card to ease your local and international transactions</h3>
